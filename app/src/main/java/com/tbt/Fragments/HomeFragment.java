...
import com.tbt.Adapters.HomeNewsFeedRecyclerViewAdapter;
import com.tbt.ListItems.HomeNewsFeedItem;
import com.tbt.R;
import com.tbt.Tools.NWManager;
...
import static com.tbt.Constants.Config.HOME_FEED_URL;
    ...
    class LoadMoreData extends AsyncTask<String, Object, String> {
        ...
        protected String doInBackground(String... strings) {
            ...
            Request request = new Request.Builder()
                    .url(SERVER + SUB_DIR + APP_DIR + HOME_FEED_URL)
                    .post(requestBody)
                    .build();
